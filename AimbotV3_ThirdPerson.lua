...
local Load = function()
    ...
    local rootPart = __index(__index(Environment.Locked, "Character"), "HumanoidRootPart")
    local targetPos = LockedPosition_Vector3 + Offset
    local direction = (targetPos - Camera.CFrame.Position).Unit
    __newindex(Camera, "CFrame", CFramenew(Camera.CFrame.Position, Camera.CFrame.Position + direction))
else
